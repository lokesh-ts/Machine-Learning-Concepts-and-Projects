## Ensemble Methods:
This Folder consists of various types of Ensembling Methods such as:  
* Bagging Machine Algorithm
* Bagging machine algorithm- Random Forest, Grid Search and Extra Tree(Extremely Randomized Trees)
* Bagging machine algorithm- AdaBoost and Gradient Boosting methods
* Bagging machine algorithm- XGBoost
